...
- Architecture: well-separated concerns. For example, there should be a section of the code that is entirely "reading all of the Claude related configuration comprehensively into a single unified, well-typed datastructure", _then_ pass that to the conversion code. Don't mix the concerns.
